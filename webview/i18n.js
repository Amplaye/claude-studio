...
(() => {
  ...
  const EN = {
    ...
    'queue.sent': 'gone out',
    'queue.head': '{n} waiting — a few seconds to change them, then they go in',
    'queue.title': 'Messages waiting to be sent',
    'queue.edit': 'Change what it says — Enter to keep it, Esc to leave it as it was. It keeps its place in the queue.',
    'queue.drop': 'Take it back — what you wrote returns to the box below',
    ...
    // ---- what it's doing right now (the pill in the header) ----
    // One word each: the pill sits beside the mode switch and has to stay short.
    'act.working': 'Working…',
    'act.thinking': 'Thinking…',
    'act.reasoning': 'Reasoning…',
    'act.writing': 'Writing…',
    'act.tool': '{tool}…',
    'act.asking': 'Your turn',
    'act.step': '1 step',
    'act.steps': '{n} steps',
    ...
    'recap.file': '1 file changed',
    'recap.files': '{n} files changed',
    'recap.more': '+{n} more',
    ...
    'ctx.stale': 'updated {age} ago',
    'ctx.rename': 'Rename',
    'ctx.close': 'Close this conversation',
    'ctx.here': 'here',
    'ctx.done': 'done',
    'ctx.doneHint': 'This one finished while you were looking somewhere else',
    'ctx.busy': 'active now',
  ...
  const IT = {
    ...
    'queue.sent': 'partito',
    'queue.head': '{n} in attesa — pochi secondi per cambiarli, poi entrano',
    'queue.title': 'Messaggi in attesa di partire',
    'queue.edit': 'Cambia quello che dice — Invio per tenerlo, Esc per lasciarlo com’era. Resta al suo posto in fila.',
    'queue.drop': 'Ritiralo — quello che hai scritto torna nel campo qui sotto',
    ...
    'act.thinking': 'Pensa…',
    'act.reasoning': 'Ragiona…',
    'act.writing': 'Scrive…',
    'act.tool': '{tool}…',
    'act.asking': 'Tocca a te',
    'act.step': '1 passo',
    'act.steps': '{n} passi',
    ...
    'recap.file': '1 file modificato',
    'recap.files': '{n} file modificati',
    'recap.more': '+altri {n}',
    ...
    'ctx.stale': 'aggiornato {age} fa',
    'ctx.rename': 'Rinomina',
    'ctx.close': 'Chiudi questa conversazione',
    'ctx.here': 'qui',
    'ctx.done': 'ha finito',
    'ctx.doneHint': 'Questa ha finito mentre guardavi da un’altra parte',
