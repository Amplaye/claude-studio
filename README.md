...
The office is furnished with tiles from the *SeasonVale* interiors set by
[CraftPix](https://craftpix.net/file-licenses/). The people who work there aren't
drawn by anyone: `npc.js` grows each one from the seed of its conversation.
